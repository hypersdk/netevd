...
| Layer | Governs |
|-------|---------|
| **[LICENSE](LICENSE)** | netevd **software** — Apache-2.0 (Community Edition; open source) |
...
By downloading, building, deploying, installing, or using netevd binaries or customer bundles from Zyvor (including `./scripts/package-binary-remote.sh` or `./install.sh` where provided), you agree to these Company Terms.
...
No license to use **Zyvor**, **zyvor.dev**, **HyperSDK**, **netevd**, or related marks except nominative/fair use. See [docs/legal/TRADEMARK-NOTICE.md](docs/legal/TRADEMARK-NOTICE.md).

## 5. Distribution and enterprise

- Offering netevd as a **managed service** or **white-label** to third parties requires written permission (legal@zyvor.dev).
...
Set `$NETEVD_ZYVOR_ACCEPT=1` or type **ACCEPT** when prompted; record under `~/.netevd/`.

---

**Version:** 1.0 · **Product:** netevd
